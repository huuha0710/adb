...
<div class="inner">
  ...
  <div class="isi">
    ...
    <div class="tombol">
      <button class="1 active">Adblock</button><button class="2">Adblock Plus</button>
    </div>
    <div class="fixblock">
      <div class="1 active">
        <ol>
        ...
        <ol>
          ...
          <li>
            The browser icon should have turned grey<br /><img
              ...
              alt="Adblock"/>
          </li> <li>Refresh the page if it didn\'t refresh automatically. Thanks!</li></ol></div></div></div></div>';
